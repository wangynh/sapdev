		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tutorial",
									"targetURL": "#fiorinorthwindui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fiorinorthwindui5-display": {
								"semanticObject": "fiorinorthwindui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiori.northwindui5",
									"url": sap.ui.require.toUrl("fiori/northwindui5")
								}
							}
						}
					}
